...
class plotLive():
    ...
    def __init__(self, fname1, fname2, figname, interval=1000): #first depth then PWM
        self.fig = plt.figure()
    ...
    #========================================================================================================#
        ...
        self.ax1.set_title('Depth Status')
    ...
    #========================================================================================================#
        ...
        self.ax2.set_title('PWM Status')
        self.ax2.set_ylabel('PWM in percentage')
        self.ax2.set_xlabel('Time (secs)')
        file2.close()
